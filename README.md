...
<div style="text-align: center;">
  <img src="https://raw.githubusercontent.com/kevin-ar-cmd/termux-root/main/images/Img2.jpg" alt="root termux" title="root termux" width="100%" />
  </div>
</centre>
...
<pre>git clone https://github.com/kevin-ar-cmd/termux-root</pre>
<pre>cd root</pre>
...
<pre>apt-get update && apt upgrade-y && apt-get install git -y && git clone https://github.dev/kevin-ar-cmd/termux-root.git</pre>
...
# Copyright
<pre>@ Copyright credits goes to Kevin Juma. This tool is public tool anyone can use this tool.</pre>
